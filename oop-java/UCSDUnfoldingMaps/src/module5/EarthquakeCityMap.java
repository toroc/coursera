...
public class EarthquakeCityMap extends PApplet {
	...
	private void selectMarkerIfHover(List<Marker> markers)
	{
		...
		//lastSelected not NULL then marker has been selected
		if(lastSelected != null){
			return;
		}
		/*Iterate thru markers, if they are
		under cursor
		* set marker as selected and as last selected
		* can be set for ONLY 1 marker*/

		for (Marker marker: markers){
			/*Cast as CommonMarker*/
