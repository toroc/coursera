...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		if (offline) {
			...
			// CHANGING PROVIDER TO Microsoft
	...
	private boolean isLand(PointFeature earthquake) {
		...
		for (Marker country: countryMarkers){
			if (isInCountry(earthquake, country)){
				System.out.println("Earthquake happend in country :" + earthquake.getProperty("country"));
//				country.setProperty("country", earthquake.getProperty("country") );
//				System.out.println(country.getProperty("country"));
				return true;
			}
		}

		// Use the isinCountry helper method
	...
	private void printQuakes() 
	{
		...
		// loop through countries and keep count of earthquakes in country
		for (Marker country: countryMarkers){
			int count = 0;
